...
{
  static final connectionCheckedProvider = Provider((ref) => GlobalFonction.connectionChecked);
  @override
  initState()  {
    //on recupert l'etate du provider ici
    super.initState();
     //ref.read(GlobalFonction.connectionCheck2);
  }
  Widget build (BuildContext context)
  {
    //final connet = ref.watch(GlobalFonction.connectionCheck2);
