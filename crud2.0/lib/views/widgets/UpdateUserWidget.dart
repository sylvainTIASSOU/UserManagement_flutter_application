                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            if(_formKey.currentState!.validate())
                            {
                             ...
                             Notifications notif = Notifications(id:null, minute: '${DateTime.now().minute.toString()}' , hour: '${DateTime.now().hour.toString()}', name: model.lastName, mode: 'updated');
                             //DatabaseManager.updateDB(model);
                             EditUserViewModel.actionButtonSaveChanges(context, model, notif, id);
