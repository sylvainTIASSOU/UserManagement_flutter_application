              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    color: Color.fromARGB(217, 211, 216, 218),
                  ),
                ),
          ...
          Container(
            ...
            child:  ElevatedButton(
                onPressed: ()  async {
                  ...
                  Notifications notif = Notifications(id: null, minute: '${DateTime.now().minute.toString()}' , hour: '${DateTime.now().hour.toString()}', name: model.lastName, mode: 'deleted');
                  UserProfilViewModel.actionButtonDelete(context, model, notif, id);
